...
class Singleton
{
   ...
   public static istance;
    ...
    public static function controllerConstructorParamerters(controller)
    {	
    ...
    public static function controllerMethodParamerters(controller,action)
    {	
